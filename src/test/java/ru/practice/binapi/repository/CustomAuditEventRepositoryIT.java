...
import ru.practice.binapi.config.audit.AuditEventConverter;
import ru.practice.binapi.domain.PersistentAuditEvent;
...
import static ru.practice.binapi.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
